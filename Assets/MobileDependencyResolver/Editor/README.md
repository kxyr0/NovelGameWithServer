...
For example, to add a Maven library
(`com.example.android:sample-library` package) at version `1.0.0` to the set of
a plugin's Android dependencies:

```xml
<dependencies>
  <androidPackages>
    <androidPackage spec="com.example.android:sample-library:1.0.0" />
  </androidPackages>
</dependencies>
```
