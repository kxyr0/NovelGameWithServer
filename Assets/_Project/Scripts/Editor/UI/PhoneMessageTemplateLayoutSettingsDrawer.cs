...
[CustomPropertyDrawer(typeof(PhoneMessageTemplateLayoutSettings))]
public sealed class PhoneMessageTemplateLayoutSettingsDrawer : PropertyDrawer
{
    ...
    {
        new Category("Sender Name", new[]
        {
            "showSenderName",
            "hideAvatar",
            "senderNameBottomSpacing",
            "senderNameOffset",
            "senderNameAnchor",
            "senderNameRelativeTo",
            "senderNameSizeOffset",
            "senderNameMargin",
            "senderNameFontSize",
            "overrideSenderNameAutoSize",
            "senderNameAutoSize",
            "senderNameMinFontSize",
            "senderNameMaxFontSize",
            "senderNameLineSpacing"
        }),
        new Category("Time Text", new[]
        {
            "showTimeText",
            "timeTextOffset",
            "timeTextSizeOffset",
            "timeTextMargin",
            "timeTextFontSize",
            "overrideTimeTextAutoSize",
            "timeTextAutoSize",
            "timeTextMinFontSize",
            "timeTextMaxFontSize",
            "timeTextLineSpacing"
        }),
        new Category("Bubble", new[]
        {
            "verticalSpacing",
            "horizontalOffset",
            "topPadding",
        ...
        new Category("Body Text", new[]
        {
            "bodyTextScale",
            "bodyFontSize",
            "overrideBodyAutoSize",
            "bodyAutoSize",
            "bodyMinFontSize",
            "bodyMaxFontSize",
            "bodyLineSpacing"
        }),
        new Category("Row", new[]
        {
            "rowPadding",
            "rowPositionOffset",
        ...
        new Category("Message Root VerticalLayoutGroup", new[]
        {
            "useMessageRootVerticalLayout",
            "messageRootVerticalLayoutPadding",
            "messageRootVerticalLayoutSpacing",
            "messageRootVerticalLayoutChildAlignment",
            "messageRootVerticalLayoutReverseArrangement",
            "messageRootVerticalLayoutControlChildWidth",
            "messageRootVerticalLayoutControlChildHeight",
            "messageRootVerticalLayoutUseChildScaleWidth",
            "messageRootVerticalLayoutUseChildScaleHeight",
            "messageRootVerticalLayoutChildForceExpandWidth",
            "messageRootVerticalLayoutChildForceExpandHeight"
        }),
        new Category("Container VerticalLayoutGroup", new[]
        {
            "overrideContainerVerticalLayout",
            "containerPadding",
            "containerSpacing",
            "containerChildAlignment",
            "containerReverseArrangement",
            "containerControlChildWidth",
            "containerControlChildHeight",
            "containerUseChildScaleWidth",
            "containerUseChildScaleHeight",
            "containerChildForceExpandWidth",
            "containerChildForceExpandHeight"
        }),
        new Category("Container ContentSizeFitter", new[]
        {
            "overrideContainerContentSizeFitter",
            "containerHorizontalFit",
            "containerVerticalFit"
        }),
        new Category("Background", new[]
        {
            "stretchBackground",
            "backgroundStretchOffsets",
            "backgroundIgnoreLayout",
