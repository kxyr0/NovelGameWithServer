...
public sealed class UIScreenMarker : MonoBehaviour
{
	[SerializeField]
	[FormerlySerializedAs("screenId")]
	[Tooltip(
		"Стабильный ID экрана, например MainMenu, Story, Settings или Shop.")]
	private string _screenId = "";

	private string _registeredScreenId = "";

	public string ScreenId =>
		UIScreenState.NormalizeScreenId(_screenId);
